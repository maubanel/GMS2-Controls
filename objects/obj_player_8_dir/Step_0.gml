...
{
	// if no keyboard input check first gameplad slot
...
// Normalize hspeed & vspeed when magnitude of vector is greater than 1
if (room != lvl_eight_dir_1)
{
...
// Player direction snaps to new position
if (room == lvl_eight_dir_3)
{
	// Points player in direction of movement direction of object
	if (speed != 0)
	{
...
if (room == lvl_eight_dir_4 || room == lvl_eight_dir_5 || room == lvl_eight_dir_6)
{
