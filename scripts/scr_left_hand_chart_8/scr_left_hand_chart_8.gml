...
if (gamepad_axis_value(global.gamepad[0], gp_axislh) != 0 && (obj_player_4_dir_5.octant == 0 || obj_player_4_dir_5.octant == 2) )
{

	draw_rectangle(first_column_x + 1, initial_y_pos + (offset * 8) + 1, second_column_x - 1,initial_y_pos + (offset * 9) - 1, false );
}	

if (gamepad_axis_value(global.gamepad[0], gp_axislv) != 0  &&( obj_player_4_dir_5.octant == 1 || obj_player_4_dir_5.octant == 3) )
{
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 10.5) , obj_player_4_dir_5.x_axis);
	
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 11.5), obj_player_4_dir_5.y_axis);
	
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 12.5), obj_player_4_dir_5.hspeed);
		
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 13.5), obj_player_4_dir_5.vspeed);
			
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 14.5), obj_player_4_dir_5.speed);
	
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 15.5), sprite_get_name(obj_player_4_dir_5.sprite_index));
	
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 16.5), obj_player_4_dir_5.image_xscale);

draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 17.5), obj_player_4_dir_5.octant);
