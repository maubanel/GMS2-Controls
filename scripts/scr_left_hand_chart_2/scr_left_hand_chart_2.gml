...
if (room == lvl_eight_dir_7 || room == lvl_eight_dir_9 )
{
	y_pos += offset;
	draw_line(l_margin_x, y_pos, second_column_x, y_pos);
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 8.5) , obj_player_8_dir_2.x_axis);
	
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 9.5), obj_player_8_dir_2.y_axis);
	
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 10.5), obj_player_8_dir_2.hspeed);
		
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 11.5), obj_player_8_dir_2.vspeed);
			
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 12.5), obj_player_8_dir_2.speed);
	
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 13.5), obj_player_8_dir_2.direction);
	
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 14.5), obj_player_8_dir_2.image_angle);
...
if (room = lvl_eight_dir_7 || room == lvl_eight_dir_9)
{
		draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 17.5), obj_player_8_dir_2.octant);
}